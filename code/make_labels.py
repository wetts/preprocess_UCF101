...
def make_dataset(csv_path, csv_target_path, dataset_path, target_path):
...
if __name__ == "__main__":
    ...
    csv_target_path = '/80f765ab0dcd4fee9c897c6ff9211e3f/userdata/zws/UCF-101/labels/train01_1.csv'
    
    
    # df = create_dataframe(label_path, dataset_path)
    # df.to_csv(csv_path, index=False)

    df = make_dataset(csv_path, csv_target_path, dataset_path, image_root_path)